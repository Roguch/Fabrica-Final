 <?php
        ...
        switch ($acao){
            ...
            case 'home':
                ...
                break;
            case 'cadastroFun':
                $checa = $crud->getUsuario($_POST['cpf']);
                $resutado = $checa->getCpf();
                if ($_POST['cpf'] != $resutado) {
            ...
            case 'cadastroFor':
                $checa = $crud3->getFornecedor($_POST['cnpj']);
                $resutado = $checa->getCnpj();
                if ($_POST['cnpj'] != $resutado) {
